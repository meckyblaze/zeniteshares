...
while($row = $result->fetch_assoc()) {
  ...
  $sql = "SELECT * FROM pghtable WHERE cgh <= '$iph' AND cgh >'0'";
$result = $conn->query($sql);
if ($result->num_rows > 0 ) {
              $sql = "SELECT * FROM pghtable WHERE cgh <= '$iph' AND cgh >'0'";
$result = $conn->query($sql);
...
while($row = $result->fetch_assoc()) {
   ...
   $sql = "UPDATE pghtable SET amountph='$new' WHERE email='" . $_SESSION["email"] . "'";
$result = $conn->query($sql);
if ($conn->query($sql) === TRUE) {
    echo "";
}
...
if ($conn->query($sql) === TRUE) {
   $sql = "UPDATE pghtable SET cgh='0' WHERE email='$Emaiip'";
$result = $conn->query($sql);
if ($conn->query($sql) === TRUE) {
...
"https://www.zeniteshares.com"</script>';
exit();
                                  ...
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                             ...
                                             Are you sure you want to cash out #<?php echo $balance;?>
...
while($row = $result->fetch_assoc()) {
   ...
   $sql = "DELETE FROM matched WHERE emailp='" . $_SESSION["email"] . "' AND 
