...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="" class="logo">ZE<span class="lite">NITE</span>SHARES</a>
            <!--logo end-->
            ...
            <div class="top-nav notification-row">                
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li>
                                <a href=""><i class="icon_mail_alt"></i> Write Testmonie</a>
                            </li>
      ...
      <aside>
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">                          
                          ...
                          <li><a class="" href="">My Details</a></li>
          ...
          <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a class="" href="">Submit ticket</a></li>
                      </ul>
                  </li>       
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
                      ...
                      <ul class="sub">
                          <li><a class="" href="">View/Write</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="">Provide</a></li>
                          <li><a class="" href="">Cash out</a></li>
                      </ul>
                  </li>
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <h4><li><i class="fa fa-home"></i><a href="" style="color: red;">ACCOUNT BLOCKED</a></li></h4>
          </ol>
        </div>
      </div>
              <!-- Form validations -->              
...
<?php echo $fmsg; ?> </div><?php } ?>
                                      ...
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">Message <span class="required">*</span></label>
                                          <div class="col-lg-10">
